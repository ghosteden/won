...
//        });
		...
		me.game.onLevelLoaded = function() {
			if (me.save.goToPlayerX != undefined && me.save.goToPlayerY != undefined && me.save.goToPlayerX != null && me.save.goToPlayerY != null) {
				me.game.getEntityByName("Player")[0].pos.x = me.save.goToPlayerX * globalVars['tileSize'];
				me.game.getEntityByName("Player")[0].pos.y = me.save.goToPlayerY * globalVars['tileSize'];
			}
		};
